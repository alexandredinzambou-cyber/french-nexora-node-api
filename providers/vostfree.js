 ...
 * Generated: 2026-09-11T18:14:25.267465227Z
 */
var __provider = (() => {
  ...
  var DOMAIN, rateLimit, HEADERS2, HTTP_SKIP_CODES;
  var init_http = __esm({
    "src/vostfree/http.js"() {
      init_resolvers();
      DOMAIN = "ipv4.vostfree.ws";
  ...
  function searchAnime(title) {
    return __async(this, null, function* () {
      try {
        ...
        try {
          const postHtml = yield fetchText(`${BASE_URL}/index.php?do=search`, {
            method: "POST",
            headers: {
          ...
          const $ = import_cheerio_without_node_native2.default.load(postHtml);
  ...
  function extractStreams(tmdbId, mediaType, season, episode) {
    return __async(this, null, function* () {
      ...
      let targetEpisodes = episode !== void 0 && episode !== null ? [episode] : [];
      if (mediaType === "tv" && targetEpisodes.length > 0 && !isBudgetExhausted(startTime, BUDGET_MS)) {
        targetEpisodes = yield resolveTargetEpisodes(tmdbId, mediaType, season, episode, { startTime, budgetMs: BUDGET_MS });
      }
      ...
      if (mediaType === "tv" && effectiveSeason !== void 0 && effectiveSeason !== null && !isBudgetExhausted(startTime, BUDGET_MS)) {
        const hasExplicitSeasonMatch = allMatches.some((m) => getSeasonNumber(m.title + " " + m.url) === effectiveSeason);
        if (!hasExplicitSeasonMatch) {
          const mainTitle = titlesOrdered.find((t) => !/[^\x00-\x7F]/.test(t) && t.length >= MIN_QUERY_LENGTH) || titlesOrdered.find((t) => t.length >= MIN_QUERY_LENGTH) || titlesOrdered[0];
          if (mainTitle && mainTitle.length >= MIN_QUERY_LENGTH) {
            ...
            const batch = yield searchAnime(seasonQuery);
      ...
      if (mediaType === "tv" && effectiveSeason !== void 0 && effectiveSeason !== null) {
      ...
      for (const match of allMatches) {
        ...
        if (mediaType === "tv") {
          ...
          if (match.genre === "FILM" || match.genre === "OAV" || skipKeywords.test(matchLower) || skipKeywords.test(matchUrlLower)) {
            continue;
          }
        }
        if (mediaType === "tv" && effectiveSeason !== void 0 && effectiveSeason !== null) {
        ...
        try {
          ...
          const playerPromises = filteredPlayers.map((el) => __async(null, null, function* () {
          ...
          const results = yield Promise.allSettled(playerPromises);
          for (const r of results) {
  ...
  var require_index = __commonJS({
    "src/vostfree/index.js"(exports, module) {
      init_extractor();
      init_resolvers();
