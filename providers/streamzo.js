 ...
 * Generated: 2026-09-11T18:14:25.143465099Z
 */
var __provider = (() => {
    ...
    return __async(this, arguments, function* (url, options = {}) {
      ...
      for (let attempt = 0; attempt <= retries; attempt++) {
        ...
        try {
          ...
          lastError = e;
          if (attempt < retries && (((_c = e.message) == null ? void 0 : _c.includes("fetch failed")) || ((_d = e.message) == null ? void 0 : _d.includes("NetworkError")) || ((_e = e.message) == null ? void 0 : _e.includes("timeout")) || ((_f = e.message) == null ? void 0 : _f.includes("no response")) || ((_g = e.message) == null ? void 0 : _g.includes("Cloudflare")))) {
            continue;
          }
          throw e;
        }
  ...
  var rateLimit, DOMAIN, RETRY_DELAYS, HEADERS2, AJAX_HEADERS;
  var init_http = __esm({
    "src/streamzo/http.js"() {
      init_resolvers();
      init_config();
  ...
  function findContent(titles, mediaType, season) {
    return __async(this, null, function* () {
      var _a;
      const year = ((_a = titles._metadata) == null ? void 0 : _a.year) || "";
      ...
      if (mediaType === "movie") {
        for (const slug of slugCandidates) {
          ...
          try {
            const html = yield fetchText(movieUrl, { timeout: 6e3 });
        ...
        for (const slug of slugCandidates) {
          ...
          try {
            const html = yield fetchText(seriesUrl, { timeout: 6e3 });
            if (html && html.length > 5e3) {
              const embedUrl = extractEmbedUrl(html);
  ...
  function resolveEmbedToStream(embedUrl, quality, lang) {
    return __async(this, null, function* () {
      ...
      try {
        const embedHtml = yield fetchText(fullEmbedUrl, { timeout: TIMEOUTS.EMBED });
  ...
  function extractStreams(tmdbId, mediaType, season, episode) {
    return __async(this, null, function* () {
      ...
      const content = yield findContent(titles, mediaType, season);
      if (!content) {
      ...
      if (content.type === "movie" || mediaType === "movie") {
        const stream = yield resolveEmbedToStream(content.embedUrl, content.quality, lang);
        if (stream) {
      ...
      if (mediaType === "tv") {
        ...
        if (episodeData) {
          ...
          const stream = yield resolveEmbedToStream(episodeData.embedUrl, content.quality, episodeData.lang);
          if (stream) {
  ...
  // src/streamzo/index.js
  var require_index = __commonJS({
    "src/streamzo/index.js"(exports, module) {
      init_extractor();
      init_resolvers();
