 ...
 * Generated: 2026-09-11T18:14:24.786464741Z
 */
var __provider = (() => {
  ...
  // src/flemmix/config.js
  var SITE, ENDPOINTS, SELECTORS, PATTERNS, TIMEOUTS, SCORES, LANGUAGE_MAP, ANIME_GENRE_ID, ANIME_KEYWORDS, CACHE_TTL, MAX_SEARCH_TITLES;
  ...
  function fetchJson(_0) {
    return __async(this, arguments, function* (url, options = {}) {
      ...
      return fetchWithRetry(() => __async(null, null, function* () {
        var _a;
        const res = yield safeFetch(url, { headers: mergedHeaders, timeout: (_a = options.timeout) != null ? _a : TIMEOUTS.SEARCH });
        if (!res) throw new Error(`No response from ${url}`);
  ...
  function createStreamsFromServers(servers, name, subType) {
    return __async(this, null, function* () {
      const results = yield Promise.allSettled(
  ...
  var init_extractor = __esm({
    "src/flemmix/extractor.js"() {
      ...
      init_config();
      init_cache();
      withCache = createCache("fl", "Flemmix");
    }
  });

  // src/flemmix/index.js
  var require_index = __commonJS({
    "src/flemmix/index.js"(exports, module) {
      init_extractor();
      init_resolvers();
