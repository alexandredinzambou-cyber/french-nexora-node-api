 ...
 * Generated: 2026-09-11T18:14:24.992464939Z
 */
var __provider = (() => {
  ...
  function isCloudflareBlock(text) {
    ...
    return text.includes("Cloudflare") || text.includes("cf-browser-verification") || text.includes("challenge-form") || text.includes("Attention Required") || text.includes("Just a moment...") || text.includes("jsd/main") || /Ray ID: [a-f0-9-]{20,}/.test(text);
  }
    ...
    return __async(this, arguments, function* (url, options = {}) {
      ...
      for (let attempt = 0; attempt <= maxRetries; attempt++) {
        ...
        try {
          ...
          if (status === 429) {
            const waitMs = RETRY_DELAYS[attempt] || 5e3;
          ...
          lastError = e;
          if (attempt < maxRetries && (((_b = e.message) == null ? void 0 : _b.includes("fetch failed")) || ((_c = e.message) == null ? void 0 : _c.includes("NetworkError")) || ((_d = e.message) == null ? void 0 : _d.includes("timeout")) || ((_e = e.message) == null ? void 0 : _e.includes("no response")) || ((_f = e.message) == null ? void 0 : _f.includes("Cloudflare")) || ((_g = e.message) == null ? void 0 : _g.includes("429")) || ((_h = e.message) == null ? void 0 : _h.includes("Rate limited")))) {
            continue;
          }
          throw e;
        }
  ...
  var BASE_URL, BASE, HEADERS2, rateLimit, DOMAIN, RETRY_DELAYS;
  var init_http = __esm({
    "src/mugiwarastream/http.js"() {
      init_resolvers();
      ...
      DOMAIN = "mugiwara-no-streaming.com";
  ...
  function createCache(namespace, tag) {
    ...
    return function withCache(_0, _1) {
  ...
  function findCachedSlugs(titles) {
    return __async(this, null, function* () {
      for (const t of titles) {
        const slugs = yield slugCache(`slugs_${t.toLowerCase()}`, () => __async(null, null, function* () {
          const found = yield findSlugs(titles);
          if (found && found.length > 0) {
            for (const other of titles) {
              if (other.toLowerCase() !== t.toLowerCase()) {
                yield slugCache(`slugs_${other.toLowerCase()}`, () => __async(null, null, function* () {
                  return found;
                }));
              }
            }
  ...
  function extractStreams(tmdbId, mediaType, season, episodeNum) {
    return __async(this, null, function* () {
      ...
      const slugs = [];
      const cachedSlugs = yield findCachedSlugs(titles);
      if (cachedSlugs && cachedSlugs.length > 0) {
        ...
        const directSearch = yield findSlugs(titles);
  ...
  var init_extractor = __esm({
    "src/mugiwarastream/extractor.js"() {
      ...
      slugCache = createCache("mg_slug", "MugiwaraSlug");
      animeDataCache = createCache("mg_data", "MugiwaraData");
    }
  });
